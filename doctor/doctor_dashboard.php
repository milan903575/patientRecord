please make sure to display the problems corresponding to the perticular doctor in private_problems table where doctor_id matches else show no private problems availabele
